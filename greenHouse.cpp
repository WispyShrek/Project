...
TEST_CASE("greenHouse::addItem(row,col) rejects invalid/occupied") {
    greenHouse gh;
    Plant* a = new Rose();
    Plant* b = new Rose();
    Plant* c = new Rose();
...
TEST_CASE("After remove, addItem(auto) fills earliest hole") {
    greenHouse gh;
    Plant* p1 = new Rose();
    Plant* p2 = new Rose();
    Plant* p3 = new Rose();
...
TEST_CASE("greenHouse::CreateIterator allows multiple independent iterators") {
    greenHouse gh;
    Plant* p1 = new Rose();
    Plant* p2 = new Rose();
    gh.addItem(p1, 0, 0);
