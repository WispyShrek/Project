...
Nursery::Nursery() {
  ...
  // initialize noting in constructor as to not be able to create a new instance
  // of the nursery pointer
}

Nursery::~Nursery() {
  // assuming that at some point nursery gets deleted the gardens and staff in
