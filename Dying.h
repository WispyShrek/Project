 ...
 *
 * The Dying class implements the behavior of a plant that is in the process of
 * dying. In this state, the plant may not transition to any other state unless
 * specific care is applied.
 */

class Dying : public PlantState {
private:
  Caretaker *prevStateCarer;

public:
  Dying(Caretaker *prevStateCarer);
